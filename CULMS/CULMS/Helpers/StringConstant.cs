...
namespace CULMS.Helpers
{
    public class StringConstant
    {
        ...
        public const string ApiKeyUrl = "https://api.cudigiclass.in/api/";
        ...
        public const string ApiKeyChangePassword = "Admin/UpdatePassword";
        ...
        public static bool IsPasswordIsValid { get; set; }
    }
}
